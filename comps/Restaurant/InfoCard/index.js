...
const InfoCard = ({
  ...
  return <CardCont style={styles.shadowProp}>
    ...
    <Content>
      <Title>{title}</Title>
      <Section>
        <Text style={{width:120, fontSize:14, fontFamily:'Quicksand_500Medium', marginTop:10}}>{sectiontitle1}</Text><Text style={{fontSize:16, fontFamily:'Quicksand_300Light', marginTop:10, marginLeft:5}}>{phone}</Text>
      </Section>
      <Section>
        <Text style={{width:120, fontSize:14, fontFamily:'Quicksand_500Medium', marginTop:10}}>{sectiontitle2}</Text><Text style={{fontSize:16, fontFamily:'Quicksand_300Light', marginTop:10, marginLeft:5}}>{addressline1}</Text>
      </Section>
      <Section>
        <Text style={{width:120, fontSize:14, fontFamily:'Quicksand_500Medium', marginTop:10}}>{cvc}</Text><Text style={{fontSize:16, fontFamily:'Quicksand_300Light', marginTop:10, marginLeft:5}}>{addressline2}</Text>
      </Section>
    </Content>
